...
import { IPromotionRepositoryToken } from '../../infrastructure/repositories/config/tokens';
...
export class PromotionService {
     ...
     */
    constructor(
        @inject(IPromotionRepositoryToken)
     ...
     * @returns Promise<Promotion | null> - The result from the repository method.
     */
    public async getBestForProduct(
        productId: number
     ...
     * @returns Promise<Promotion> - The result from the repository method.
     */
    public async applyToProduct(
        productId: number,
        promotionId: number
    ): Promise<Promotion> {
        return await this.promotionRepository.applyToProduct(
            productId,
            promotionId
        );
    }
