...
interface CategoriesDropdownProps<T> {
    options: T[];
    selectedOption: T;
...
const CategoriesDropdown = <T,>({
    options,
    selectedOption,
    setSelectedOption,
    renderOptionLabel,
}: CategoriesDropdownProps<T>) => {
    ...
    return (
        ...
        >
            <div className="bg-charcoalgrayP1-200 text-charcoalgrayP1 border border-gray-300 rounded-md cursor-pointer p-2 flex justify-between items-center">
